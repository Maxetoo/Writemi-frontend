  ...
  return (
    <Wrapper>
      ...
      <div className='message-container'>
        <h3 className='main-header'>Welcome to writemi</h3>
        <p className='msg'>
        ...
        <ol>
          <li>
            Scope of T&C. These T&C apply to your use of the writemi app,
            including any updates or enhancements to the app, as well as any
            other related services or features provided by writemi.
          </li>
          <li>
          ...
          <li>
            ...
            direct, indirect, consequential, or other damages resulting from
            your use of the app. This includes, but is not limited to, damages
          ...
          <li>
            Governing law. These T&C and your use of the app will be governed by
            and construed in accordance with the laws of the United States.
          </li>
          <li>
            Dispute resolution. Any disputes arising out of or related to these
            T&C or the app shall be resolved through binding arbitration in
